  ...
  <header id="header" className="fixed-top d-flex align-items-center header-transparent">
    <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
      <div className="logo me-auto">
        <h1><a href="index.html">Kokos</a></h1>
        {/* Uncomment below if you prefer to use an image logo */}
        {/* <a href="index.html"><img src="HotelAsset/assets3/img/logo.png" alt="" class="img-fluid"></a>*/}
      </div>
    ...
    <div className="hero-container">
      <div id="heroCarousel" data-bs-interval={5000} className="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div className="carousel-inner" role="listbox">
          {/* Slide 1 */}
          <div className="carousel-item active" style={{backgroundImage: 'url(HotelAsset/assets3/img/slide/slide-1.jpg)'}}>
            <div className="carousel-container">
              <div className="carousel-content">
                <h2 className="animate__animated animate__fadeInDown"><span>Kokos</span> Restaurant</h2>
  ...
  <main id="main">
    ...
    <section id="about" className="about">
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-5 align-items-stretch video-box" style={{backgroundImage: 'url("HotelAsset/assets3/img/about.jpg")'}}>
            ...
            <div className="tab-content">
              <div className="tab-pane active show" id="tab-1">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="HotelAsset/assets3/img/specials-1.jpg" alt className="img-fluid" />
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-2">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="HotelAsset/assets3/img/specials-2.jpg" alt className="img-fluid" />
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-3">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="HotelAsset/assets3/img/specials-3.jpg" alt className="img-fluid" />
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-4">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="HotelAsset/assets3/img/specials-4.jpg" alt className="img-fluid" />
                  </div>
                </div>
              </div>
              <div className="tab-pane" id="tab-5">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src="HotelAsset/assets3/img/specials-5.jpg" alt className="img-fluid" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="row g-0">
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-1.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-1.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-2.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-2.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-3.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-3.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-4.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-4.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-5.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-5.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-6.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-6.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-7.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-7.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="gallery-item">
              <a href="HotelAsset/assets3/img/gallery/gallery-8.jpg" className="gallery-lightbox">
                <img src="HotelAsset/assets3/img/gallery/gallery-8.jpg" alt className="img-fluid" />
              </a>
            </div>
          </div>
        </div>
  ...
  <footer id="footer">
    <div className="container">
      ...
      <div className="copyright">
        © Copyright <strong><span>Kokos</span></strong>. All Rights Reserved
      </div>

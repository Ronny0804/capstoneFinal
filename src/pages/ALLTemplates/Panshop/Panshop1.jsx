        ...
        >
          <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
            <div className="logo me-auto">
              ...
              {/* <a href="index.html"><img src="../assets1/img/logo.png" alt classname="img-fluid" /></a> */}
            </div>
            ...
            <div className="container-fluid">
              <div className="row">
                <div
                  ...
                  style={{ backgroundImage: 'url("../assets1/img/about.jpg")' }}
                >
                  <a
                    ...
                    <div className="tab-pane active show" id="tab-1">
                      <div className="row">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                          <img
                            src="../assets1/img/specials-1.png
                            "
                            alt
                            className="img-fluid"
                          />
                    ...
                    <div className="tab-pane" id="tab-2">
                      <div className="row">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2 border-radius-50 ">
                          <img
                            src="../assets1/img/specials-2.png"
                            alt
                            className="img-fluid"
                          />
                        </div>
    ...
    <div className="row g-0">
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-1.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-1.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-2.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-2.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-3.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-3.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-4.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-4.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-5.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-5.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-6.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-6.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-7.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-7.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
      <div className="col-lg-3 col-md-4">
        <div className="gallery-item">
          <a href="assets1/img/gallery/gallery-8.png" className="gallery-lightbox" data-gall="gallery-item">
            <img src="assets1/img/gallery/gallery-8.png" alt className="img-fluid" />
          </a>
        </div>
      </div>
    </div>

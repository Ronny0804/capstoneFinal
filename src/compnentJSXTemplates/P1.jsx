...
import '../../src/pages/ALLTemplates/Panshop/Panshop1.css'
              ...
              <div className="row">
                ...
                <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch">
                  <div className="content">
                    ...
                    <ul>
                      <li>
                        <i className="bx bx-check-double" /> {data.pointone}
                      </li>
                      <li>
                        <i className="bx bx-check-double" /> {data.pointtwo}
                      </li>
                      <li>
                        <i className="bx bx-check-double" /> {data.pointthree}
                      </li>
                    </ul>
                    <p>

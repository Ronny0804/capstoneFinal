...
import '../../src/pages/ALLTemplates/Panshop/Panshop2.css'
...
const [allbagImg,setAllBagImg] = useState([]);
  ...
  {/* ======= Hero Section ======= */}
  <section id="hero" className="hero d-flex align-items-center section-bg" style={{backgroundImage:`url(${heroImg})`,backgroundSize : "cover" }}>
        ...
        <div className="row gy-4">
          <div className="col-lg-4" data-aos="fade-up" data-aos-delay={100}>
            <div className="why-box">
              <h3>Why Choose {data.hotelname}</h3>
              <p>

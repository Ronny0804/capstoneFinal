...
import '../../src/pages/ALLTemplates/Hotel/Hotel2.css'
const H2 = ({data}) => {
  ...
  <header id="header" className="header fixed-top d-flex align-items-center">
    <div className="container d-flex align-items-center justify-content-between">
      <a href="index.html" className="logo d-flex align-items-center me-auto me-lg-0">
        ...
        <h1>{data.hotelname}<span>.</span></h1>
      </a>
  ...
  <section id="hero" className="hero d-flex align-items-center section-bg">
    <div className="container">
      <div className="row justify-content-between gy-5">
        ...
        <img src={data.ourBagImg} className="img-fluid" alt data-aos="zoom-out" data-aos-delay={300} />
        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay={300}>
            <div className="content ps-0 ps-lg-5">
              ...
              <ul>
                <li><i className="bi bi-check2-all" />{data.pointone}</li>
                <li><i className="bi bi-check2-all" />{data.pointtwo}</li>
                <li><i className="bi bi-check2-all" />{data.pointthree}</li>
              </ul>
              <p>
              ...
              <div className="tab-pane active show" id="tab-1">
                <div className="row">
                  ...
                  <div className="col-lg-4 text-center order-1 order-lg-2">
                    <img src={data.allImgs.id} alt className="img-fluid" />
                  </div>
                </div>
              </div>
        ...
        <div className="row gy-4">
          ...
          <div className="col-md-6">
            <div className="info-item  d-flex align-items-center">
              ...
              <div>
                <h3>Opening Hours</h3>
                <div><strong>Mon-Sat:</strong>{data.openHours}
      ...
      <div className="row gy-3">
        ...
        <div className="col-lg-3 col-md-6 footer-links d-flex">
          ...
          <div>
            <h4>Opening Hours</h4>
            <p>
              <strong>Mon-Sat:  {data.openHours}</strong><br />
              Sunday: Closed
            </p>
          </div>
        </div>

...
import '../../src/pages/ALLTemplates/Hotel/Hotel3.css'
const H3 = ({data}) => {
...
const [allbagImg,setAllBagImg] = useState([]);
 ...
 console.log(data)
  ...
  <header id="header" className="fixed-top d-flex align-items-center header-transparent">
    <div className="container-fluid container-xl d-flex align-items-center justify-content-between">
      <div className="logo me-auto">
        <h1><a href="index.html">{data.hotelname}</a></h1>
  ...
  {/* ======= Hero Section ======= */}
  <section id="hero" style={{backgroundImage:`url(${heroImg})`,backgroundSize : "cover" }}>
          ...
          {/* Slide 1 */}
            ...
            <div className="carousel-container">
              <div className="carousel-content">
                <h2 className="animate__animated animate__fadeInDown"><span>{data.hotelname}</span> Restaurant</h2>
        ...
        <div className="row">
          ...
          <div className="col-lg-7 d-flex flex-column justify-content-center align-items-stretch">
            <div className="content">
              ...
              <ul>
                <li><i className="bx bx-check-double" /> {data.pointone}</li>
                <li><i className="bx bx-check-double" />{data.pointtwo}</li>
                <li><i className="bx bx-check-double" />{data.pointthree}</li>
              </ul>
              <p>

    ...
    <div className="row portfolio-container" data-aos="fade-up" data-aos-delay={200}>
      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-1.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Masala 1</h4>
            <p>Masala</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-1.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 1"><i className="bx bx-plus" /></a>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-web">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-2.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat 1</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-2.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-3.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Masala 2</h4>
            <p>Masala</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-3.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 2"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-card">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-4.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat 2</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-4.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 2"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-web">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-5.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Masala 3</h4>
            <p>Masala</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-5.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 2"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-app">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-6.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-6.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="App 3"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-card">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-7.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-7.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 1"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-card">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-8.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-8.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Card 3"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-4 col-md-6 portfolio-item filter-web">
        <div className="portfolio-wrap">
          <img src="assets4/img/portfolio/portfolio-9.png" className="img-fluid" alt />
          <div className="portfolio-info">
            <h4>Sweat</h4>
            <p>Sweat</p>
            <div className="portfolio-links">
              <a href="assets4/img/portfolio/portfolio-9.png" data-gallery="portfolioGallery" className="portfolio-lightbox" title="Web 3"><i className="bx bx-plus" /></a>
              <a href="portfolio-details.html" title="More Details"><i className="bx bx-link" /></a>
            </div>
          </div>
        </div>

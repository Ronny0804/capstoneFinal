              ...
              <div className="row g-0">
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-1.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-1.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-2.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-2.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-3.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-3.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-4.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-4.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-5.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-5.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-6.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-6.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-7.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-7.png"
                        alt
                        className="img-fluid"
                      />
                    </a>
                ...
                <div className="col-lg-3 col-md-4">
                  <div className="gallery-item">
                    <a
                      href="../assets1/img/gallery/gallery-8.png"
                      className="gallery-lightbox"
                    >
                      <img
                        src="../assets1/img/gallery/gallery-8.png"
                        alt
                        className="img-fluid"
                      />
                    </a>

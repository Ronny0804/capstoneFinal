  ...
  <main id="main">
          ...
          <div className="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay={300}>
            <div className="content ps-0 ps-lg-5">
              ...
              <div className="position-relative mt-4">
                <img src="assets2/img/about-2.jpg" className="img-fluid" alt />
    ...
    <section id="menu" className="menu">
      <div className="container" data-aos="fade-up">
        <div className="section-header">
          <h2>Our Menu</h2>
          <p>Check Our <span>Taj Menu</span></p>
        </div>
          ...
          <div className="tab-pane fade active show" id="menu-starters">
            ...
            <div className="row gy-5">
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-1.png" className="glightbox"><img src="assets2/img/menu/menu-item-1.png" className="menu-img img-fluid" alt /></a>
                <h4>Magnam Tiste</h4>
              ...
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-2.png" className="glightbox"><img src="assets2/img/menu/menu-item-2.png" className="menu-img img-fluid" alt /></a>
                <h4>Aut Luia</h4>
                <p className="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-3.png" className="glightbox"><img src="assets2/img/menu/menu-item-3.png" className="menu-img img-fluid" alt /></a>
                <h4>Est Eligendi</h4>
                <p className="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-4.png" className="glightbox"><img src="assets2/img/menu/menu-item-4.png" className="menu-img img-fluid" alt /></a>
                <h4>Eos Luibusdam</h4>
                <p className="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-5.png" className="glightbox"><img src="assets2/img/menu/menu-item-5.png" className="menu-img img-fluid" alt /></a>
                <h4>Eos Luibusdam</h4>
                <p className="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div className="col-lg-4 menu-item">
                <a href="assets2/img/menu/menu-item-6.png" className="glightbox"><img src="assets2/img/menu/menu-item-6.png" className="menu-img img-fluid" alt /></a>
